...
#index 1.jpg 2.jpg ... 9.jpg ... 11.jpg
def cmp(path1,path2):
    index1 = int(path1.split('/')[-1].split('.')[0])
    index2 = int(path2.split('/')[-1].split('.')[0])
...
if __name__ == '__main__':
  ...
  if args.imgdir:
    ...
    img_files = sorted(glob.glob(os.path.join(args.imgdir, '*.jpg')),cmp=cmp)
    #print(img_files)
